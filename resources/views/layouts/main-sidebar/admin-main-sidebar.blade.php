        ...
        <div class="page-wrapper chiller-theme toggled">
            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content">
                    ...
                    <a href="{{ url('/dashboard') }}" style="font-size: x-large; color: white"><b>Dashboard</b></a>
                    <!-- sidebar-header  -->
                    <!-- sidebar-search  -->
                        ...
                        <ul>
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li>
                                            <a href="{{route('Grades.index')}}">{{trans('main_trans.Grades_list')}}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="sidebar-dropdown">
                                <a href="#">
                                    ...
                                    <span>{{trans('main_trans.classes')}}</span>

                                </a>
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li>
                                            <a href="{{route('Classrooms.index')}}">{{trans('main_trans.List_classes')}}
                            ...
                            <li class="sidebar-dropdown">
                                <a href="#">
                                    ...
                                    <span>{{trans('main_trans.sections')}}</span>
                                </a>
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li>
                            ...
                            <li class="sidebar-dropdown">
                                <a href="#">
                                    <i class="far fa-gem"></i>
                                    <span>{{trans('main_trans.Accounts')}}</span>
                                </a>
                                <div class="sidebar-submenu">
                                    <ul>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('Students.index')}}">{{trans('main_trans.list_students')}}</a>
                                        </li>
                                        <li>
                                            <a href="{{route('Promotion.index')}}">{{trans('main_trans.add_Promotion')}}</a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                <a href="{{url('/eventpage')}}"><i class="fas fa-cogs"></i><span class="right-nav-text">التقويم</span></a>
                                </a>
                            </li>
                            <li>
